    ...
    const messages = [
      {
        role: 'system',
        content:
          'You are a helpful teaching assistant that is responding to a beginner student. Please be patient and clear with your answers.',
      },
    ...
    const messages = [
      {
        role: 'system',
        content:
          'You are a helpful teaching assistant that is responding to a beginner student. Pleas be patient and clear with your answers.',
      },
      { role: 'user', content: prompt },
    ]
